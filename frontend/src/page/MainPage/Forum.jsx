    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-28 lg:py-0 max-w-6xl">
        ...
        <div className="flex justify-end mb-4">
          <Link
            to="/notice"
            className="px-5 py-2 bg-white text-gray-900 rounded-lg hover:bg-gray-100 trasition-colors duration-300 flex items-center gap-2 border border-gray-200"
                ...
                <Link to={`/notice/${notice.id}`} className="block">
                  <div className="p-6 flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mt-2 text-gray-500 ">{new Date(notice.createdAt).toISOString().split('T')[0]}</div>
                    </div>
                    <div className="ml-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
