...
function Statistics() {
  ...
  const [dateFrom, setDateFrom] = useState(new Date().getFullYear().toString());
  ...
  const fetchVisitStats = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:3001/api/statistics/visits`,
        { params }
      );
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (e.target.value === "month") {
                    ...
                    setDateFrom(currentYear);
                    setDateTo(currentYear);
                  }
                }}
